...
export function SiteFooter() {
  return (
    <footer className="border-outline-variant/60 bg-surface-container-low mt-auto border-t">
      <div className="mx-auto flex w-full max-w-350 flex-col gap-6 px-4 py-10 sm:flex-row sm:items-end sm:justify-between sm:px-6">
        ...
        <div className="t-body-small text-on-surface-variant flex flex-wrap items-center gap-4">
